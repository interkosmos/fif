program compiler
    ...
    contains
        ...
        ! Lazy heuristic for kind of parsing arithmetic statements.
        ! not really complete or correct, just gives some amount of error message.
        ...
        subroutine code_gen(output, nvars, variables, ndims, dims, do_table, nstatements, statements, nlines, lines)
            ...
            do i = 1, nlines
                ...
                if (type == stmt_do) then
                    ...
                    write (uout, "(a,a,a)") "if (iftmp == 0) goto L" // trim(equal) // ";"
                    write (uout, "(a,a,a)") "if (iftmp > 0) goto L" // trim(greater) // ";"
                    write (uout, "(a)")     "}"
